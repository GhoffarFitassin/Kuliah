...
SELECT
	e.[empid], e.[lastname], e.[firstname], e.[title], o.[mgrid],
	CASE
		WHEN e.[mgrid] = 1 THEN 'Davis'
		WHEN e.[mgrid] = 2 THEN 'Funk'
		WHEN e.[mgrid] = 3 THEN 'Lew'
		WHEN e.[mgrid] = 5 THEN 'Buck'
		ELSE 'Other'
	END AS mgrlastname,
	CASE
		WHEN e.[mgrid] = 1 THEN 'Sara'
		WHEN e.[mgrid] = 2 THEN 'Don'
		WHEN e.[mgrid] = 3 THEN 'Judy'
		WHEN e.[mgrid] = 5 THEN 'Sven'
		ELSE 'Other'
	END AS mgrfirstname
FROM [HR].[Employees] AS e
JOIN [HR].[Employees] AS o ON e.empid = o.mgrid
